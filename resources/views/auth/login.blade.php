<x-guest-layout>
    <div class="text-center mb-6">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Masuk ke Akun Anda</h2>
        <p class="text-gray-600 dark:text-gray-400">Silakan masuk untuk mengakses sistem SR-KKP</p>
    </div>
