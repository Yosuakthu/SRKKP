<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="shrink-0 flex items-center">
                <a href="{{ route('dashboard') }}" class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 dark:text-white">SR-KKP</h1>
                        <p class="text-xs text-gray-600 dark:text-gray-400">Sistem Rekomendasi BBM Khusus Penugasan</p>
                    </div>
                </a>
            </div>
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <x-nav-link :href="route('permohonan.create')" :active="request()->routeIs('permohonan.create')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('permohonan.create')" :active="request()->routeIs('permohonan.create')">
                {{ __('Ajukan Permohonan') }}
            </x-responsive-nav-link>
        </div>
